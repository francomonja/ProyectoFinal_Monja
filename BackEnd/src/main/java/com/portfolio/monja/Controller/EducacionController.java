...
import com.portfolio.monja.Dto.DtoEdu;
import com.portfolio.monja.Entity.Educacion;
import com.portfolio.monja.Security.Controller.Mensaje;
import com.portfolio.monja.Service.SEducacion;
...
public class EducacionController {
    ...
    public ResponseEntity<?> create(@RequestBody DtoEdu dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreEdu(), dtoeducacion.getDescripcionEdu(), dtoeducacion.getfInicio(), dtoeducacion.getfFinal()
            );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoEdu dtoeducacion){
        ...
        educacion.setfInicio(dtoeducacion.getfInicio());
        educacion.setfFinal(dtoeducacion.getfFinal());
